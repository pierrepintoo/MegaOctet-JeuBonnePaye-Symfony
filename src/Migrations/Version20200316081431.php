 ...
 */
final class Version20200316081431 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Jouer (id INT NOT NULL, partie_id INT DEFAULT NULL, user_id INT DEFAULT NULL, classement INT DEFAULT NULL, argent INT DEFAULT NULL, cartes VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, pion INT DEFAULT NULL, box VARCHAR(255) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_general_ci`, de INT DEFAULT NULL, tour INT DEFAULT NULL) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
